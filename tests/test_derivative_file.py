...
import h5pulsar.pulsar  # noqa: E402
from h5pulsar.derivative_file import FilePulsar, format_version  # noqa: E402
...
def psr_roundtrip(request):
    ...
    with tempfile.TemporaryDirectory(prefix="enterprise-testing-") as d:
        ...
        if timing_package == "pint":
            if h5pulsar.pulsar.pint is None:
                pytest.skip(reason="PINT is not available")
            psr = h5pulsar.pulsar.Pulsar(
